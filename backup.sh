...
#DBNAME=test#Имя базы данных для резервного копирования
DBFILENAME=testba#Имя дампа базы данных
ARFILENAME=dirba #Имя архива с файлами
#HOST=localhost #Хост MySQL
#USER=root #Имя пользователя базы данных
#PASSWD=P@ssw0rd #Пароль от базы данных
DATADIR=/backups#Путь к каталогу где будут храниться резервные копии
SRCFILES=/home/www-data #Путь к каталогу файлов для архивирования
